...
const KIND = "correct" as const;
const TITLE = "Suggest a correction";
const EYEBROW = "Keep this page honest";
const INTRO = "Every field on a profile records who supplied it and when it was checked. Tell us what is out of date.";
const NEEDS_SIGN_IN = false;
